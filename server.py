...
from commands.EchoBot import EchoBot
from commands.Reminder import Reminder


### REGISTER your custom commands
MatterMostRequestHandler.registerCommand ( Reminder('remind', mattermost_url, mattermost_port, ['ofego3gprby3xnizbrx4c88xuo'], default_integration) )
